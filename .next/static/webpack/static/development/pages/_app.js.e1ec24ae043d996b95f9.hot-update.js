...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Scene, [{
    ...
    value: function componentDidMount() {
      ...
      ontrols.dampingFactor = 0.25;
      controls.enableZoom = true;
      var loader = new this.THREE.TextureLoader(); // let mtlLoader = new MTLLoader();

      var objLoader = new this.THREE.OBJLoader();
      var ship_material = new three__WEBPACK_IMPORTED_MODULE_6__["MeshBasicMaterial"]({
        color: 0x444444
      }); // objLoader.setMaterials(materials)

      objLoader.load('/hand.obj', function (obj) {
        object = obj;
...
//# sourceMappingURL=_app.js.e1ec24ae043d996b95f9.hot-update.js.map